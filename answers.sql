...
SELECT models.name, models.brand_name, brands.headquarters FROM models JOIN brands ON (models.brand_name=brands.name) WHERE brand_name='Ford' AND models.name='Mustang';
...
SELECT models.name, models.brand_name, brands.founded FROM models JOIN brands ON (brands.name=models.brand_name);
